...
import type { Product as _Product, ProductId as _ProductId, UserProfile as _UserProfile, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async associateBlobWithProduct(arg0: ProductId, arg1: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.associateBlobWithProduct(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateOrder(arg0: OrderId, arg1: OrderUpdate): Promise<void> {
        if (this.processError) {
            try {
...
function from_candid_record_n16(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        imageBlobId: record_opt_to_undefined(from_candid_opt_n17(_uploadFile, _downloadFile, value.imageBlobId))
    };
}
...
function to_candid_record_n9(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        category: value.category,
        priceInCents: value.priceInCents,
        imageBlobId: value.imageBlobId ? candid_some(value.imageBlobId) : candid_none()
    };
}
